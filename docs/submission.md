...
| Contract | ID |
|---|---|
| `verifierRegistration` | `CBZ6STD6S4Y4FV5WWJYYTUSVGZPV5UIGFXKIP23XXATKKDNJIZNJIOOS` |
| `verifierTransfer`     | `CDWJRLXX5LZVE73TJ3FUWI4PHCSNOM2S5ZBXSCGQSEVMP6PW7C75OLG7` |
| `verifierWithdraw`     | `CDEAARD5U36JASGHMV6DUW2E3VQUGSQ2RH5U5X55N76TBVEQYQD756ZP` |
| `registrar`            | `CBM6674HPJCMRQ7ND6TZXVYRSXILGGFFM47D635MANW4ZJBLBDFX5ZSP` |
| `confidentialToken`    | `CBML6NCKFNMYQZEJYIVMFSGSVJCXOHDCPVX3EZIUBNY7XIGPQAQ4DCP3` |
